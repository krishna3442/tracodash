...
<html lang="en-US">
 ...
 <form class = "form-horizontal" role = "form" autocomplete="off" action="registration.jsp" method="post">
   ...
   <label class="radio-inline">
      <input type="radio" value="Cab" name="account" >Cab
    </label>
    <label class="radio-inline">
        <input type="radio" value="User" name="account" checked>User
    </label>
    <label class="radio-inline">
   ...
   <div class = "form-group">
      ...
      <div class = "col-sm-6">
         <input type = "password" class = "form-control" id = "pass" name="pass" placeholder = "Enter Password" autocomplete="new-password">
      </div>
   </div>
