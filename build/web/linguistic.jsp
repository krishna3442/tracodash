...
<html lang="en-US">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   <body class="size-1140">
               ...
               <div class="top-nav s-12 l-10">
                  ...
                  <ul class="right">
                     <li><a href="index.jsp">Home</a></li>
                      <li><a href="history linguistic.jsp">history</a></li>
      ...
      <section>
<div class="testbox">
  <h1>Logistics Registration</h1>

  <form action="linguistic register.jsp" method="POST" class = "form-horizontal">
      <div class = "form-group">
      <label for = "cname" class = "col-sm-5 control-label">Service Name</label>
		
      <div class = "col-sm-6">
<input type="text" name="cname" id="cname" placeholder="Service Name" required class = "form-control"/>
      </div>
      </div>
     <div class = "form-group">
